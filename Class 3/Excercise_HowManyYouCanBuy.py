...
print(" Hi {}.Your product is {}.Price of each product is {}.You have total money {}.Hence you can bring {} number of product.You will be left with money {}".format(name,product,unitprice,totalMoney,quantities,money_left))
